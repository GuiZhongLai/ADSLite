...
struct AdsSymbolEntry
{
    ...
    unsigned long flags;          // see ADSSYMBOLFLAG_*
    unsigned short nameLength;    // length of symbol name (null terminating character not counted)
    unsigned short typeLength;    // length of type name (null terminating character not counted)
    unsigned short commentLength; // length of comment (null terminating character not counted)
};
